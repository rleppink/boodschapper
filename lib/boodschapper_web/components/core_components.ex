defmodule BoodschapperWeb.CoreComponents do
  @moduledoc """
  ...
  import BoodschapperWeb.Gettext
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-zinc-700/10 ring-zinc-700/10 relative hidden rounded-2xl bg-white p-14 shadow-lg ring-1 transition duration-75"
            >
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-4 inset-x-0 mx-auto w-80 sm:w-96 z-50 rounded-lg p-3 ring-1",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BoodschapperWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BoodschapperWeb.Gettext, "errors", msg, opts)
    end
  end
